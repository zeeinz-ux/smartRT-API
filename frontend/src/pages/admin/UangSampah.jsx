    ...
    <div className="uang-sampah">
      ...
      <div className="us-header">
        <div className="us-header__left">
          <h1 className="us-header__title">Uang Sampah</h1>
          <p className="us-header__subtitle">
            Kelola iuran kebersihan bulanan warga RT 003
          </p>
        </div>
        <div className="us-header__right">
          <div className="us-month-picker">
            <button className="us-month-picker__btn" onClick={handlePrevMonth}>
              <ChevronLeft size={16} />
            </button>
            ...
            <button className="us-month-picker__btn" onClick={handleNextMonth}>
          ...
          <div className="modal modal--small" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal__body">
              <p style={{ fontSize: "0.9rem", color: "var(--clr-text-secondary)", marginBottom: "var(--space-md)" }}>
                Yakin ingin menghapus pembayaran <strong>{selectedWarga.nama}</strong> untuk bulan{" "}
                {BULAN.find((b) => b.value === bulan)?.label} {tahun}?
              </p>
            </div>
            <div className="modal__footer">
