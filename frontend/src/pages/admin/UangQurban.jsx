...
import "../../assets/style/css/UangQurban.css";
...
export default function UangQurban() {
  ...
  return (
    <div className="uang-sampah">
      ...
      <IuranTable
        title="Uang Qurban"
        subtitle="Kelola iuran qurban tahunan warga RT 003"
        bulan={bulan}
        tahun={tahun}
        BULAN={BULAN}
        now={now}
        ...
        prevDisabled={bulan === 0}
        nextDisabled={bulan === 0}
      ...
      <BayarModal
        ...
        subtitle={bulan > 0 ? `${BULAN.find((b) => b.value === bulan)?.label} ` : "" + tahun}
      />
      ...
      <DeleteModal
        ...
        bulan={bulan}
        tahun={tahun}
        bulanLabel={bulan > 0 ? BULAN.find((b) => b.value === bulan)?.label : null}
